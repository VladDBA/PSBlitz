...
|`-QueryStoreTop`|Used to specify if more/less than the default top 20 queries should be returned for the Query Store step. <br>Setting this parameter to 0 will skip the Query Store analysis step altogether.<br>Defaults to 20.|
